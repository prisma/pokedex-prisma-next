...
- Then ask: _"Want me to help fill this in? Give me a rough description and I'll draft it."_
...
- If no description was given yet, ask:
  _"Give me a short description of what needs to be built: problem, users, rough scope. I'll draft the spec from there."_
...
3. **Derive acceptance criteria.** Extract testable acceptance criteria from the functional requirements, non-functional requirements, and any explicit success conditions. Each criterion should be:
   ...
   - Traceable: maps back to a specific requirement
     ...
     _"The spec doesn't define clear success conditions for [area]. What does 'done' look like for this?"_
...
4. When satisfied, confirm with the engineer:
   _"The spec looks solid. Remaining items in Open Questions are implementation-time decisions. Ready to finalise?"_
