...
```typescript
function createRepository<TEntity, TKey>(connection: Connection): Repository<TEntity, TKey> {
  // Implementation
}
...
function fetchData(onSuccess: (data: Data) => void, onError: (error: Error) => void) {}
...
function fetchData(success: (data: Data) => void, error: (error: Error) => void) {}
