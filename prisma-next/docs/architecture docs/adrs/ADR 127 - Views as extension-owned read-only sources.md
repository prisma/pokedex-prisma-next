      ...
      "views": [
        {
          ...
          "dependencies": [{ "schema": "public", "name": "user", "kind": "table" }],
          "materialized": false,
          "refreshPolicy": null
        },
        {
...
```json
{
  ...
  "sources": {
    "public.user_summary": {
      "readOnly": true,
      "projection": { "user_id": { "type": "int4" }, "post_count": { "type": "int8" } },
      "origin": { "namespace": "postgres", "kind": "view", "id": "pg.view:public.user_summary@..." }
    },
    "analytics.daily_signups": {
      "readOnly": true,
      "projection": { "day": { "type": "timestamptz" }, "count": { "type": "int8" } },
      "origin": {
        "namespace": "postgres",
        "kind": "view",
        "id": "pg.view:analytics.daily_signups@..."
