...
- Violations become LINT._ or BUDGET._ with ruleId or budgetId populated
...
- Lint and budget plugins consistently use LINT._ and BUDGET._ codes with severity from policy
...
- Do we reserve sub-namespaces for community adapters, e.g. ADAPTER.VENDOR\_\*
