...
export interface SqlRuntimeTargetDescriptor<
  ...
  >,
>
  extends RuntimeTargetDescriptor<"sql", TTargetId, TTargetInstance>, SqlStaticContributions {}

export interface SqlRuntimeAdapterDescriptor<
  TTargetId extends string = string,
  TAdapterInstance extends RuntimeAdapterInstance<"sql", TTargetId> =
    SqlRuntimeAdapterInstance<TTargetId>,
>
  extends RuntimeAdapterDescriptor<"sql", TTargetId, TAdapterInstance>, SqlStaticContributions {}

export interface SqlRuntimeExtensionDescriptor<TTargetId extends string = string>
  extends
    RuntimeExtensionDescriptor<"sql", TTargetId, SqlRuntimeExtensionInstance<TTargetId>>,
