...
type FieldsOf<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
...
type ModelFieldToColumnMap<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
...
type FieldToColumnMapSafe<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
  ModelFieldToColumnMap<TContract, ModelName> extends Record<string, string>
    ? ModelFieldToColumnMap<TContract, ModelName>
    : never;

type ModelTableFromMappings<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
...
type ModelTableFromModel<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
...
type ModelStorageTableDef<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
  ModelTableName<TContract, ModelName> extends infer TableName extends string
...
type UniqueConstraintColumns<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
  ModelStorageTableDef<TContract, ModelName> extends {
...
type TableRelations<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
  ModelTableName<TContract, ModelName> extends infer TableName extends string
...
type LegacyModelRelations<TContract extends SqlContract<SqlStorage>, ModelName extends string> =
